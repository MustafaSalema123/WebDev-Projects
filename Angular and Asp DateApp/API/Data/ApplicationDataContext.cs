...
namespace API.Data
{
    public class ApplicationDataContext  : IdentityDbContext<AppUser , AppRole , int,
       ...
       // public DbSet<AppUser> Users { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder) 
        {
            ...
            builder.Entity<UserLike>().HasKey
                (k =>new {k.SourcesUserId,k.TargetUserId});

            builder.Entity<UserLike>()
               .HasOne(s => s.SourcesUser)
               .WithMany(l => l.LikedUsers)
               .HasForeignKey(s => s.SourcesUserId)
    ...
    //public class YourDbContextFactory : IDesignTimeDbContextFactory<ApplicationDataContext>
    //{
